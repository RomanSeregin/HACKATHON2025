...
class DungeonWin(Screen, ABC):
    ...
    def setup(self):
        self.elements = [
            Image(0, 0, f'{questsPath}/dungeon/Win/images/background.png'),
            Button('next', 525, 615, f'{questsPath}/dungeon/Win/buttons/next.png', None, destination='dungeonTreaty')
        ]
