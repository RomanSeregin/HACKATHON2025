...
class BastionWin(Screen, ABC):
    ...
    def setup(self):
        self.elements = [
            Image(0, 0, f'{questsPath}/bastion/Win/images/background.png'),
            Button('next', 525, 615, f'{questsPath}/bastion/Win/buttons/next.png', None, destination='bastionTreaty')
        ]
