...
class Ending0(Screen, ABC):
    ...
    def setup(self):
        self.elements = [
            Image(0, 0, f'{endingPath}/ending0/images/background.png'),
            Button('next', 621, 477, f'{endingPath}/ending0/buttons/next.png', None, destination='ending1')
        ]
