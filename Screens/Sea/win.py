...
class SeaWin(Screen, ABC):
    ...
    def setup(self):
        self.elements = [
            Image(0, 0, f'{questsPath}/sea/Win/images/background.png'),
            Button('next', 525, 615, f'{questsPath}/sea/Win/buttons/next.png', None, destination='seaTreaty')
        ]
